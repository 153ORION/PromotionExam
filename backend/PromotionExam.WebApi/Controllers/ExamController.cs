...
namespace PromotionExam.WebApi.Controllers
{
    ...
    public class ExamController : ControllerBase
    {
        ...
        //        reg.ExamStart,
        //        reg.ExamEnd,
        //        RemainingSeconds = reg.ExamEnd.HasValue ? Math.Max(0, (int)(reg.ExamEnd.Value - DateTime.Now).TotalSeconds) : 3600
        //    });
        //}
        ...
        //    var remainingSeconds = reg.ExamEnd.HasValue ? Math.Max(0, (int)(reg.ExamEnd.Value - DateTime.Now).TotalSeconds) : 3600;
        ...
        [AllowAnonymous]
        [HttpGet("getExamInfo")]
        public async Task<ResponseDTO> getExamInfo([FromQuery] int hrrecordId)
        {
        ...
        [AllowAnonymous]
        [HttpGet("examStart")]
        public async Task<ResponseDTO> examStart([FromQuery] int examineeId)
        {
        ...
        public async Task<ResponseDTO> checkExamState([FromQuery] int examineeId)
        {
        ...
        [AllowAnonymous]
        [HttpGet("answerSheet")]
        public async Task<ResponseDTO> answerSheet([FromQuery] int examineeId)
        {
        ...
        public async Task<ResponseDTO> submitAnswer([FromBody] SubmitAnsDTO ansDTO)
        {
        ...
        [AllowAnonymous]
        [HttpPost("examEnd")]
        public async Task<ResponseDTO> examEnd([FromBody] ExamFinishDTO examFinishDTO)
        {
